                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="positionID" name="position_id" required="">
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="teamID" name="team_id" required="">
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="text" maxlength="20" class="form-control number-format" id="baseSalary" name="base_salary" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="taxStatus" name="tax_status" required="">
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="paymentFrequency" name="payment_frequency" required="">
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="form-group">
                                ...
                                <div class="input-group date" data-provide="datepicker">
                                    ...
                                    <input type="text" id="hiredate" name="hire_date" placeholder="mm/dd/yyyy" class="form-control pull-right datepicker" required>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="workshift" name="workshift_id" required="">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="text" maxlength="50" class="form-control" id="firstname" name="first_name" placeholder="Juan" required="">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="text" maxlength="50" class="form-control" id="lastname" name="last_name" placeholder="dela Cruz" required="">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="form-group">
                                ...
                                <div class="input-group date">
                                    ...
                                    <input type="text" id="birthdate" name="birth_date" placeholder="mm/dd/yyyy" class="form-control pull-right datepicker" required="">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" maxlength="50" class="form-control" id="mobile" name="mobile_number" required="">
                                </div>
                            </div>
